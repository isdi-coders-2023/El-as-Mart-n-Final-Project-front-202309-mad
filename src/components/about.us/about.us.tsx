  ...
  return (
    <div className="about-us-container">
      ...
      <div className="text-section-4">
        Este dato nos impulsó a tomar una posición activa en la lucha contra el
        impacto ambiental de la moda. Creemos firmemente en la importancia de
        generar conciencia sobre este tema y abogamos por un cambio de
      ...
      <div className="text-section-5">
        ...
        segunda mano, fomentando un estilo único y auténtico. Nuestra tienda de
        ropa de segunda mano no solo ofrece opciones sostenibles y respetuosas
        con el medio ambiente, sino que también te invita a descubrir piezas
        únicas y con estilo propio.
      </div>
      <div className="text-section-6">
        ¿Qué más puedes pedir? Únete a nosotros en este viaje hacia una moda más
        consciente y vibrante, donde cada prenda cuenta una historia única.
      </div>
    </div>
  );
}
